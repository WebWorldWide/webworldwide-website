...
(function () {
  ...
  const ICONS = {
    ...
    tag: svg(
      '<path d="M20.6 13.4 13.4 20.6a2 2 0 0 1-2.8 0l-7-7A2 2 0 0 1 3 12.2V5a2 2 0 0 1 2-2h7.2a2 2 0 0 1 1.4.6l7 7a2 2 0 0 1 0 2.8Z"/><circle cx="7.5" cy="7.5" r="1.2"/>',
    ),
    ...
    shortcodes: svg('<path d="m8 9-4 3 4 3M16 9l4 3-4 3"/>'),
    settings: svg(
    ...
    // ── Topbar / actions ──────────────────────────────────────
    theme_dark: svg('<path d="M21 12.8A9 9 0 1 1 11.2 3 7 7 0 0 0 21 12.8Z"/>'),
    theme_light: svg(
