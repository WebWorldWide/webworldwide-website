...
before(async () => {
  ...
  writePost('one', { title: 'One', date: '2024-01-01', draft: false }, 'first');
  writePost('two', { title: 'Two', date: '2024-01-02', draft: true }, 'second');
  writePost('three', { title: 'Three', date: '2024-01-03', draft: false }, 'third');
