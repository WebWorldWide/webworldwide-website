...
sudo cp /var/lib/docker/volumes/web-world-wide_remark_data/_data/remark.db $BACKUP_REPO_DIR/remark42_backup.db
# Ensure ownership
...
sudo cp /var/lib/docker/volumes/web-world-wide_cms_data/_data/auth.db $BACKUP_REPO_DIR/cms_auth_backup.db
